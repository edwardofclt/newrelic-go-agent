...
// (https://godoc.org/github.com/edwardofclt/newrelic-go-agent/_integrations) directory --
...
// (https://godoc.org/github.com/edwardofclt/newrelic-go-agent#Transaction) API.  In this
