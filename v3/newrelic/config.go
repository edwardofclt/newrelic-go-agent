...
import (
	...
	"github.com/edwardofclt/newrelic-go-agentlic-go-agent/v3/internal/utilization"
)
...
type Config struct {
	...
	//
	// See https://github.com/edwardofclt/newrelic-go-agentlic-go-agent/blob/master/GUIDE.md#logging
...
type config struct {
	...
	// https://github.com/edwardofclt/newrelic-go-agentlic-go-agent/issues/127
