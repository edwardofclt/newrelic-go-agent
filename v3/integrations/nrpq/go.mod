module github.com/edwardofclt/newrelic-go-agent/v3/integrations/nrpq
...
replace github.com/edwardofclt/newrelic-go-agent/v3 v3.3.0 => ../../../v3

replace github.com/edwardofclt/newrelic-go-agent/v3/newrelic => ../../../v3/newrelic
