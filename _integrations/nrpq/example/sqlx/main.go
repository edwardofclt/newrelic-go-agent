...
// `InstrumentSQLDriver`
// (https://godoc.org/github.com/edwardofclt/newrelic-go-agent#InstrumentSQLDriver) API.
// See
// https://github.com/edwardofclt/newrelic-go-agent/blob/master/_integrations/nrmysql/nrmysql.go
// for a full example.
//
