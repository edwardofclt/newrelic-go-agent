...
// (https://godoc.org/github.com/edwardofclt/newrelic-go-agent#FromContext).
//
...
//
// Full server example:
// https://github.com/edwardofclt/newrelic-go-agent/blob/master/_integrations/nrmicro/example/server/server.go
//
// Micro Clients
//
...
//
// Full client example:
// https://github.com/edwardofclt/newrelic-go-agent/blob/master/_integrations/nrmicro/example/client/client.go
//
// Micro Producers
//
...
// https://github.com/edwardofclt/newrelic-go-agent/blob/master/_integrations/nrmicro/example/pubsub/main.go
//
// Micro Subscribers
//
