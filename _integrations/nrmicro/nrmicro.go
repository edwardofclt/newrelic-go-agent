...
// (https://godoc.org/github.com/edwardofclt/newrelic-go-agent#NewContext) when calling one
// of those methods.
...
// `newrelic.NewContext`
// (https://godoc.org/github.com/edwardofclt/newrelic-go-agent#NewContext) when calling
// `Call`.
